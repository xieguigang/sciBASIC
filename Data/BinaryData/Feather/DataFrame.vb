#Region "Microsoft.VisualBasic::491d90a2494d7a859e0acdd51edbf5dd, Data\BinaryData\Feather\DataFrame.vb"
    ...
    '   Total Lines: 639
    '    Code Lines: 423 (66.20%)
    ' Comment Lines: 102 (15.96%)
    '    - Xml Docs: 77.45%
    ' 
    '   Blank Lines: 114 (17.84%)
    '     File Size: 24.68 KB
    ...
    ' 
    '     Function: IsNullTranslated, ReadBool, ReadDouble, ReadFloat, ReadInt16
    '               ReadInt32, ReadInt64, ReadInt8, (+2 Overloads) ReadString, ReadUInt16
    '               ReadUInt32, ReadUInt64, ReadUInt8, TranslateIndex, (+2 Overloads) TryGetColumn
    '               TryGetColumnTranslated, TryGetRow, TryGetRowTranslated, (+4 Overloads) TryGetValue, TryGetValueTranslated
    '               TryLookupTranslatedColumnIndex, TypeForTranslated, UntranslateIndex
    ' 
    '     Sub: Dispose, UnsafeFastGetRowRange
    ' 
    ' /********************************************************************************/

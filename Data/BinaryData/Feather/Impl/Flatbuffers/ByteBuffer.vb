#Region "Microsoft.VisualBasic::85bad879db0daed513d5733afa583538, Data\BinaryData\Feather\Impl\Flatbuffers\ByteBuffer.vb"
    ...
    ' 
    '         Function: [Get], GetDouble, GetFloat, GetInt, GetLong
    '                   GetSbyte, GetShort, GetUint, GetUlong, GetUshort
    '                   ReadLittleEndian, (+3 Overloads) ReverseBytes, ToString
    ' 
    '         Sub: AssertOffsetAndLength, Put, (+2 Overloads) PutByte, PutDouble, PutFloat
    '              PutInt, PutLong, PutSbyte, PutShort, PutUint
    '              PutUlong, PutUshort, Reset, WriteLittleEndian
    ' 
    ' 
    ' /********************************************************************************/

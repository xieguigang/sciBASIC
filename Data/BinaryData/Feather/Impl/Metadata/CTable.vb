#Region "Microsoft.VisualBasic::9c08259a6843320a706719233e4cae9e, Data\BinaryData\Feather\Impl\Metadata\CTable.vb"
    ...
    '     Class CTable
    ' 
    '         Properties: ByteBuffer, ColumnsLength, Description, Metadata, NumRows
    '                     Version
    ' 
    '         Function: __assign, Columns, CreateColumnsVector, CreateCTable, EndCTable
    '                   GetDescriptionBytes, GetMetadataBytes, (+2 Overloads) GetRootAsCTable
    ' 
    '         Sub: __init, AddColumns, AddDescription, AddMetadata, AddNumRows
    '              AddVersion, FinishCTableBuffer, StartColumnsVector, StartCTable
    ' 
    ' 
    ' /********************************************************************************/

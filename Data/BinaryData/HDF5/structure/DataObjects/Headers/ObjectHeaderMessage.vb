#Region "Microsoft.VisualBasic::d0f7ea634a3c3f71db4b39fda6a9bd87, Data\BinaryData\HDF5\structure\DataObjects\Headers\ObjectHeaderMessage.vb"
    ...
    '   Total Lines: 231
    '    Code Lines: 180 (77.92%)
    ' Comment Lines: 23 (9.96%)
    '    - Xml Docs: 30.43%
    ' 
    ...
    ' 
    '         Function: resolveSharedMessage, ToString
    ' 
    '         Sub: printValues
    ' 
    ' 
...
#End Region
        ...
        Private Function resolveSharedMessage([in] As BinaryReader, sb As Superblock) As ObjectHeaderMessage
            ...
            If targetAddress >= 0 Then
                ...
                Throw New IOException("shared message target does not contain message type " & Me.headerMessageType.ToString)
            End If

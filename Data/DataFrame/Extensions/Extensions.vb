#Region "Microsoft.VisualBasic::a8ac24eab59ce9387f83a9f4e340e53d, Data\DataFrame\Extensions\Extensions.vb"
    ...
    '   Total Lines: 670
    '    Code Lines: 383 (57.16%)
    ' Comment Lines: 213 (31.79%)
    '    - Xml Docs: 92.96%
    ' 
    '   Blank Lines: 74 (11.04%)
    '     File Size: 29.01 KB
...
Public Module Extensions
    ...
    Public Function LoadTsv(Of T As Class)(path As DefaultString, Optional encoding As Encoding = Nothing) As IEnumerable(Of T)
        Return path.DefaultValue.LoadTsv(Of T)(encoding, mute:=True)
    End Function

#Region "Microsoft.VisualBasic::7cd4e92e74932552e8ffa91ff6afc1ac, Data\DataFrame\IO\CSVText\File.vb"
    ...
    '   Total Lines: 1006
    '    Code Lines: 615 (61.13%)
    ' Comment Lines: 259 (25.75%)
    '    - Xml Docs: 96.91%
    ' 
    '   Blank Lines: 132 (13.12%)
    '     File Size: 40.72 KB
...
......"
        ...
        ''' 对于<see cref="DataFrameResolver"/>类型而言，由于在创建对象的时候，第一行数据由于需要被用作为header，
...
#End Region
        ...
        ''' <summary>
        ''' 这个方法是保存<see cref="DataFrameResolver"></see>对象之中的数据所需要的
        ''' </summary>
        ''' <returns></returns>
        ''' <remarks></remarks>

#Region "Microsoft.VisualBasic::9a704d11122c1b96d9e4937d28080fb5, Data_science\DataMining\DBNCode\dbn\BayesNet.vb"
    ...
    '   Total Lines: 592
    '    Code Lines: 366 (61.82%)
    ' Comment Lines: 125 (21.11%)
    '    - Xml Docs: 64.80%
    ' 
    '   Blank Lines: 101 (17.06%)
    '     File Size: 25.42 KB


    '     Class BayesNet
    ' 
    '         Properties: MarkovLag, Parameters, Parents, Top
    ' 
    '         Constructor: (+6 Overloads) Sub New
    ' 
    '         Function: (+2 Overloads) compare, generateProbabilities, getParameters, learnParameters, nextObservation
    '                   toDot, (+2 Overloads) ToString
    ' 
    '         Sub: generateParameters, learnParameters
    ' 
    ' 
    ' /********************************************************************************/

#Region "Microsoft.VisualBasic::233d44f7112ae657f026c13f52f6e065, Data_science\DataMining\DBNCode\dbn\CrossValidation.vb"
    ...
    '   Total Lines: 817
    '    Code Lines: 430 (52.63%)
    ' Comment Lines: 66 (8.08%)
    '    - Xml Docs: 0.00%
    ' 
    '   Blank Lines: 321 (39.29%)
    '     File Size: 26.29 KB
    ...
    ' 
    '         Function: calculateFoldIds, countInstancesOfClass, countInstancesOfFold, evaluate, evaluate2
    '                   evaluateFold, setRandomSeed
    ' 
    '         Sub: InitializeInstanceFields
    '         Class Pair
    ' 
    '             Constructor: (+1 Overloads) Sub New
    ' 

...
Namespace UMAP
    Public NotInheritable Class Umap
        Private Const SMOOTH_K_TOLERANCE As Single = 1e-5F
        Private Const MIN_K_DIST_SCALE As Single = 1e-3F
        Private ReadOnly _learningRate As Single = 1F
        Private ReadOnly _localConnectivity As Single = 1F
...
''' 
        ...
        Private NotInheritable Class OptimizationState
            ...
            Public A As Single = 1.5769434603113077F
            Public B As Single = 0.8950608779109733F
            ...
            Public Function GetDistanceFactor(ByVal distSquared As Single) As Single
                Return 1F / ((0.001F + distSquared) * CSng(A * Math.Pow(distSquared, B) + 1))
            End Function
        End Class
    End Class
End Namespace

#Region "Microsoft.VisualBasic::2496b2cf1bf41719256fc5f12df1ce69, Data_science\Graph\MST\Kruskal.vb"
...
Namespace MinimumSpanningTree
    ...
    Public Class Kruskal
        ...
        Public Function calculateNumNodes(edges As IEnumerable(Of VertexEdge)) As Integer
            Return (From i As VertexEdge
                    In edges
                    Select NodeIdTuple(i)).IteratesALL.Distinct.Count
        End Function

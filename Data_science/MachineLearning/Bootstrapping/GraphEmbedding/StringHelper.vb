...
Friend Module StringHelper
    ...
    '----------------------------------------------------------------------------------
    <Extension()>
    Public Function SubstringSpecial(self As String, start As Integer, [end] As Integer) As String
    ...
    '------------------------------------------------------------------------------------
    <Extension()>
    Public Function StartsWith(self As String, prefix As String, toffset As Integer) As Boolean
    ...
    '------------------------------------------------------------------------------
    <Extension()>
    Public Function Split(self As String, regexDelimiter As String, trimTrailingEmptyStrings As Boolean) As String()
        ...
        If trimTrailingEmptyStrings Then
            If splitArray.Length > 1 Then
                For i = splitArray.Length To 1 Step -1
    ...
    '-----------------------------------------------------------------------------
    Public Function NewString(bytes As SByte()) As String
        Return NewString(bytes, 0, bytes.Length)
    End Function
    Public Function NewString(bytes As SByte(), index As Integer, count As Integer) As String
        Return Encoding.UTF8.GetString(CType(CObj(bytes), Byte()), index, count)
    End Function
    Public Function NewString(bytes As SByte(), encoding As String) As String
        Return NewString(bytes, 0, bytes.Length, encoding)
    End Function
    Public Function NewString(bytes As SByte(), index As Integer, count As Integer, encoding As String) As String
    ...
    '--------------------------------------------------------------------------------
    <Extension()>
    Public Function GetBytes(self As String) As SByte()
        Return GetSBytesForEncoding(Encoding.UTF8, self)
    End Function
    <Extension()>
    Public Function GetBytes(self As String, encoding As Encoding) As SByte()
        Return GetSBytesForEncoding(encoding, self)
    End Function
    <Extension()>
    Public Function GetBytes(self As String, encoding As String) As SByte()

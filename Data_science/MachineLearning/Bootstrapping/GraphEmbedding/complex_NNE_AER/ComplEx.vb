#Region "Microsoft.VisualBasic::6c1b8e123300e2e78e8400b47f0ead12, Data_science\MachineLearning\Bootstrapping\GraphEmbedding\complex_NNE_AER\ComplEx.vb"
    ...
    '   Total Lines: 188
    '    Code Lines: 163 (86.70%)
    ' Comment Lines: 3 (1.60%)
    '    - Xml Docs: 100.00%
    ' 
...
Namespace GraphEmbedding.complex_NNE_AER
    ...
    Public Class ComplEx : Inherits Algorithm
        ...
        Public Overrides Sub initialization(strNumRelation As String, strNumEntity As String, fnTrainTriples As String, fnValidTriples As String, fnTestTriples As String, fnAllTriples As String, other As Dictionary(Of String, String))
            ...
            m_MatrixR_prefix = "model/MatrixR-k" & m_NumFactor.ToString() & "-lmbda" & m_Lambda.ToString("F5") & "-gamma" & m_Gamma.ToString("F5") & "-mu" & m_Mu.ToString("F5") & "-neg" & m_NumNegative.ToString() & "-min_pca" & m_pca.ToString("F5")

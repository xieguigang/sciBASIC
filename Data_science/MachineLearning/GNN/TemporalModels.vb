#Region "Microsoft.VisualBasic::7d12b74321c9d942a6e1f35fb7c62787, Data_science\MachineLearning\GNN\TemporalModels.vb"
    ...
    '     Function: Backward, Forward, ForwardNodeLevel
    ' 
    ' Class A3TGCNModel
    ' 
    '     Constructor: (+1 Overloads) Sub New
    ...
    ' 
    '     Properties: TrainLossHistory, ValLossHistory
    ' 
    '     Constructor: (+1 Overloads) Sub New
    ' 
    ...
    ' 
    '     Function: CreateSlidingWindowDataset, Denormalize, MAE, MAPE, Normalize
    '               RMSE
    ' 
    ' /********************************************************************************/

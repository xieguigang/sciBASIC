#Region "Microsoft.VisualBasic::9770ef44655a54c9706e0f315a5a07cd, Data_science\MachineLearning\MachineLearning\SVM\RangeTransform\RangeTransform.vb"
        ...
        Public Shared Function Compute(prob As Problem, lowerBound As Double, upperBound As Double) As RangeTransform
            ...
            For i = 0 To prob.count - 1
                ...
                For j = 0 To prob.X(i).Length - 1
                    ...
                    minVals(index) = std.Min(minVals(index), value)
                    maxVals(index) = std.Max(maxVals(index), value)
                Next
            Next

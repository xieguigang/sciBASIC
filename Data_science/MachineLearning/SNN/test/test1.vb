...
Module test1
    ...
    Private Function BatchTensor(data As Double()(), idx As Integer(), offset As Integer, count As Integer) As Tensor
        Dim f = data(0).Length
    ...
    Private Function AllTensor(d As NumericTable) As Tensor
        Dim n = d.nsamples

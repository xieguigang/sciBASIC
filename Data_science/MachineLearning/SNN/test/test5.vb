#Region "Microsoft.VisualBasic::a7c620c1dbac2f06b8f75b5787417c2e, Data_science\MachineLearning\SNN\test\test5.vb"
    ...
    '   Total Lines: 410
    '    Code Lines: 293 (71.46%)
    ' Comment Lines: 53 (12.93%)
    '    - Xml Docs: 9.43%
    ' 
    '   Blank Lines: 64 (15.61%)
    '     File Size: 18.12 KB


    ' Module test5
    ' 
    '     Function: ElementwiseMaxError, LossGradientCheck, MaskFreezeCheck, MaskTensor, MaxAbs
    '               PerturbedCurrents, RandomTensor, ReadoutGradientCheck, RecurrentGradientCheck
    ' 
    '     Sub: RecurrentLayerSelfCheck
    ' 
    ' /********************************************************************************/

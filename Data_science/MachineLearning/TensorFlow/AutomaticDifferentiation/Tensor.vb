#Region "Microsoft.VisualBasic::15dc1eadafa861b2144b4e2bb6e868ce, Data_science\MachineLearning\TensorFlow\AutomaticDifferentiation\Tensor.vb"
    ...
    '   Total Lines: 660
    '    Code Lines: 401 (60.76%)
    ' Comment Lines: 144 (21.82%)
    '    - Xml Docs: 95.83%
    ' 
    '   Blank Lines: 115 (17.42%)
    '     File Size: 24.23 KB
    ...
    ' 
    '         Function: Add, AddNorm, Concat, Dropout, Flatten
    '                   GetDerivatives, getItem, GetMaxIndex, MatAdd, MatDivElementWise
    '                   MatMul, MatMulElementWise, Pow, Scale, Softmax
    '                   ToString, Transpose, VecAdd
    ' 
    '         Sub: ClearDerivatives, GenerateNormalRandomValues, Mask, MatAdd, ReLU
    '              setItem, TransferDerivatives
    ' 
    '         Operators: (+3 Overloads) -, (+3 Overloads) *, (+2 Overloads) /, (+3 Overloads) +
    ' 
    ' 
    ' /********************************************************************************/
...
Imports Microsoft.VisualBasic.MachineLearning.TensorFlow.AutomaticDifferentiation.Parallel

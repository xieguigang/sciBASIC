#Region "Microsoft.VisualBasic::e0fb5bcfb3b78c3cb1a7bba61125f9fe, Data_science\MachineLearning\xgboost\test\Training.vb"
...
Public Class Training
    ...
    Const file_model = "G:\GCModeller\src\R-sharp\test\demo\machineLearning\XGBoost\test.xgb"

    Public Shared Sub training()
        Dim file_training = "G:\GCModeller\src\R-sharp\test\demo\machineLearning\XGBoost\train.csv"
        Dim file_validation = "G:\GCModeller\src\R-sharp\test\demo\machineLearning\XGBoost\val.csv"
        ...
        ModelSerializer.save_model(tgb).FlushAllLines(file_model)
    End Sub

    Public Shared Sub testing()
        Dim file_testing = "G:\GCModeller\src\R-sharp\test\demo\machineLearning\XGBoost\test.csv"
        Dim file_output = "G:\GCModeller\src\R-sharp\test\demo\machineLearning\XGBoost\test_result.csv"
        Dim tgb As GBM = ModelSerializer.load_model(file_model.ReadAllLines)
        Dim test As TestData = Tabular.ReadTestData(file_testing)

        tgb.predict(test).AsCharacter.SaveTo(file_output)
    End Sub

...
Namespace Sundials.CVODE
    ...
    Public Class CVODEOptions
        ...
        ''' 相对误差容差
        ''' </summary>
        Public Property RelativeTolerance As Double = 1.0E-4

        ''' <summary>
        ''' 绝对误差容差（标量或向量）
        ''' </summary>
        Public Property AbsoluteTolerance As Double = 1.0E-8
...
#Region "常量定义"
        ...
        ' 默认相对误差
        Private Const DEFAULT_REL_TOL As Double = 1.0E-4
        ' 默认绝对误差
        Private Const DEFAULT_ABS_TOL As Double = 1.0E-8
        ' 最小步长因子
        ...
        ' 零阈值
        Private Const ZERO_THRESHOLD As Double = 1.0E-15

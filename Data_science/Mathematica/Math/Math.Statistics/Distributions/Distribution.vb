#Region "Microsoft.VisualBasic::eceaddac5bf3e71490a2b4576490e171, sciBASIC#\Data_science\Mathematica\Math\Math.Statistics\Distributions\Distribution.vb"
...
Namespace Distributions
    Public Class Distribution
        Private Shared ReadOnly Z_MAX As Double = 6.0
        Private Shared ReadOnly Z_EPSILON As Double = 0.000001
        Private Shared ReadOnly CHI_EPSILON As Double = 0.000001
        Private Shared ReadOnly CHI_MAX As Double = 99999.0
        Private Shared ReadOnly LOG_SQRT_PI As Double = 0.57236494292470008
        Private Shared ReadOnly I_SQRT_PI As Double = 0.56418958354775628
        Private Shared ReadOnly BIGX As Double = 200.0
        Private Shared ReadOnly I_PI As Double = 0.31830988618379069
        Private Shared ReadOnly F_EPSILON As Double = 0.000001
        Private Shared ReadOnly F_MAX As Double = 9999.0

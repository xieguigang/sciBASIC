#Region "Microsoft.VisualBasic::c0774a787617a75ce626d68d6998c7b8, Data_science\Mathematica\Math\Math.Statistics\Distributions\LinearMoments\Gumbel.vb"
...
Namespace Distributions.LinearMoments
    ...
    Public Class Gumbel
        ...
        Public Overrides Function GetCDF(value As Double) As Double
            Return std.Exp(-std.Exp(-(value - _Xi) / _Alpha))
        End Function
        Public Overrides Function GetPDF(value As Double) As Double
            Return (1 / _Alpha) * std.Exp(-(value - _Xi) / _Alpha) * std.Exp(-std.Exp(-(value - _Xi) / _Alpha))
        End Function

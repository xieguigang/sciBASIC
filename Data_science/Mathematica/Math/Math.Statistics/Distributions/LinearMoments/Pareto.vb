#Region "Microsoft.VisualBasic::3fbbfb8654e5b01a326630de484b6a07, Data_science\Mathematica\Math\Math.Statistics\Distributions\LinearMoments\Pareto.vb"
...
Namespace Distributions.LinearMoments
    ...
    ''' </summary>
    Public Class Pareto : Inherits Distributions.ContinuousDistribution
        ...
        Public Overrides Function GetInvCDF(probability As Double) As Double
            If _K <> 0 Then
                Return _Xi + (_Alpha * (1 - std.Pow(1 - probability, _K)) / _K)
            Else
                Return _Xi - _Alpha * std.Log(1 - probability)
            End If
        End Function
        Public Overrides Function GetCDF(value As Double) As Double
            Return 1 - std.Exp(-Y(value))
        End Function
        Public Overrides Function GetPDF(value As Double) As Double
            Return (1 / _Alpha) * std.Exp(-(1 - _K) * Y(value))
        End Function

#Region "Microsoft.VisualBasic::bea9b66af33c6d15377fc0edade84080, Data_science\Mathematica\Math\Math.Statistics\Distributions\MethodOfMoments\Exponential.vb"
...
Namespace Distributions.MethodOfMoments
    ...
    Public Class Exponential
        ...
        Public Overrides Function GetInvCDF(probability As Double) As Double
            Return std.Log(probability) / _Lambda
        End Function
        Public Overrides Function GetCDF(value As Double) As Double
            Return 1 - std.Exp(-_Lambda * value)
        End Function
        Public Overrides Function GetPDF(value As Double) As Double
            If value < 0 Then
                Return 0
            Else
                Return _Lambda * std.Exp(-_Lambda * value)
            End If
        End Function

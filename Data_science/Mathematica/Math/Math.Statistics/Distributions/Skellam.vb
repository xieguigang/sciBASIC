#Region "Microsoft.VisualBasic::57ae440c928bec7057b6bb33f3351d8a, Data_science\Mathematica\Math\Math.Statistics\Distributions\Skellam.vb"
    ...
    '   Total Lines: 352
    '    Code Lines: 195 (55.40%)
    ' Comment Lines: 97 (27.56%)
    '    - Xml Docs: 88.66%
    ' 
    '   Blank Lines: 60 (17.05%)
    '     File Size: 15.67 KB


    '     Module Skellam
    ' 
    '         Function: dpois, dskellam, dskellamSP, dzipois, Finite
    '                   (+2 Overloads) pskellam, pskellamSP, SaddlepointCDF
    ' 
    ' 
    ' /********************************************************************************/

#Region "Microsoft.VisualBasic::277d7a69a3d822d95ef4b0c442d2ef19, Data_science\Mathematica\Math\Math\Algebra\LP\LPPSolverTwoPhased.vb"
    ...
    '   Total Lines: 1174
    '    Code Lines: 779 (66.35%)
    ' Comment Lines: 195 (16.61%)
    '    - Xml Docs: 55.90%
    ' 
    '   Blank Lines: 200 (17.04%)
    '     File Size: 44.91 KB


    '     Class LPPSolverTwoPhased
    ' 
    '         Properties: iterationLimit
    ' 
    '         Constructor: (+1 Overloads) Sub New
    ' 
    '         Function: ChooseEntering, ExtractSolution, NeedsPhase1, normType, Phase1
    '                   Phase2, RunSimplex, Solve
    ' 
    '         Sub: Build, BuildTableau, BuildVariableMapping, DriveArtificialsOut, ExtractColumn
    '              Pivot, PriceOut, PurgeArtificialColumns, ResetObjective
    ' 
    ' 
    ' /********************************************************************************/

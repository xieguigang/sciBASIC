#Region "Microsoft.VisualBasic::e22490f4736517034c3243d94592dbd7, Data_science\Mathematica\Math\Math\Algebra\MILP\MilpModel.vb"
    ...
    '   Total Lines: 267
    '    Code Lines: 136 (50.94%)
    ' Comment Lines: 73 (27.34%)
    '    - Xml Docs: 78.08%
    ' 
    '   Blank Lines: 58 (21.72%)
    '     File Size: 10.36 KB
    ...
    '     Class MilpVariable
    ' 
    '         Properties: IsBinary, IsInteger, VarType
    ' 
    ...
    '     Class MilpModel
    ' 
    '         Properties: Constraints, ObjectiveSense, Variables
    ' 
    '         Function: AddConstraint, AddVariable, ObjectiveCoefficients, ToLppProblem, ToString
    '                   Validate, VariableIndex, VariableNames
    ' 
    ' 
    ' /********************************************************************************/

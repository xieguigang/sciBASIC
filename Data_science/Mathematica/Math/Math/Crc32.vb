...
Namespace HtmlAgilityPack
    Public Class Crc32
        ' Methods
        Friend Function AddToCRC32(ByVal c As Integer) As UInt32
            Return Me.AddToCRC32(CUShort(c))
        End Function

        Friend Function AddToCRC32(ByVal c As UInt16) As UInt32
            Dim octet As Byte = CByte((c And &HFF))
            Dim num2 As Byte = CByte((c >> 8))
            Me._crc32 = Crc32.UPDC32(num2, Me._crc32)
            Me._crc32 = Crc32.UPDC32(octet, Me._crc32)
            Return Not Me._crc32
        End Function
        ...
        Public Shared Function CRC32String(ByVal [text] As String) As UInt32
            ...
            Do While (length > 0)
                length -= 1
                Dim num3 As UInt16 = [text].Chars(length)
        ...
        Private Shared Function UPDC32(ByVal octet As Byte, ByVal crc As UInt32) As UInt32
            Return (Crc32.crc_32_tab(CInt(DirectCast(((crc Xor octet) And &HFF), IntPtr))) Xor (crc >> 8))
        End Function


        ' Properties
        Friend Property CheckSum As UInt32
            Get
                Return Me._crc32
            End Get

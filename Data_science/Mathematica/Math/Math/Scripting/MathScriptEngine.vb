#Region "Microsoft.VisualBasic::e4fa33443fa9a6aaf8d5e5f87dca3789, Data_science\Mathematica\Math\Math\Scripting\MathScriptEngine.vb"
    ...
    '   Total Lines: 539
    '    Code Lines: 436 (80.89%)
    ' Comment Lines: 43 (7.98%)
    '    - Xml Docs: 46.51%
    ' 
    '   Blank Lines: 60 (11.13%)
    '     File Size: 23.39 KB
    ...
    ' 
    '         Properties: DataLoader
    ' 
    '         Function: ApplyUserFuncVector, EvalExprVector, EvaluateCall, EvalUserFunc, ExprReferencesVector
    '                   GetVariable, HandleDataCommand, IsBuiltin, MakeAxis, ParseArgs
    '                   ResolveArg, ResolveArgVector, ResolveSurfaceZ, ResolveVector, RunScript
    '                   VectorLength
    ' 
    '         Sub: AddFunction, BindScalars, HandlePlot, ProcessAssignment, ProcessLine

...
Module HalfTest
    ...
    Sub memoryTest()
        ...
        Call $"Takes {t1}ms to allocate {HeapSizeOf.MeasureSize(vector) / 1024} KB".__DEBUG_ECHO
        Call $"Takes {t2}ms to allocate {HeapSizeOf.MeasureSize(sparse) / 1024} KB".__DEBUG_ECHO
        Call $"Takes {t3}ms to allocate {HeapSizeOf.MeasureSize(halfs) / 1024} KB".__DEBUG_ECHO

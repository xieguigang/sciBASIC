#Region "Microsoft.VisualBasic::441a476f92fa97c65b46ac3a988087f5, Data_science\Mathematica\Math\MathLambda\Symbolic\MakeSimplify.vb"
    ...
    '   Total Lines: 455
    '    Code Lines: 344 (75.60%)
    ' Comment Lines: 51 (11.21%)
    '    - Xml Docs: 31.37%
    ' 
    '   Blank Lines: 60 (13.19%)
    '     File Size: 19.91 KB


    '     Module MakeSimplify
    ' 
    '         Function: canonicalKey, combineProduct, combineSum, foldSpecialSquare, isLiteralOne
    '                   isLiteralZero, isNegated, makeFunc, makeSimple, matchTrigSquared
    '                   simplifyExpr, simplifyPower, simplifyProduct, simplifyQuotient, simplifyRaw
    '                   simplifySum, tryTrigSum
    ' 
    '         Sub: addFactor, splitSumTerm
    '         Class TermGroup
    ' 
    ' 
    ' 

#Region "Microsoft.VisualBasic::7b363c685555fe472d68d2850f2aa366, Data_science\Mathematica\Math\MathLambda\Symbolic\Polynomial.vb"
    ...
    '   Total Lines: 735
    '    Code Lines: 575 (78.23%)
    ' Comment Lines: 70 (9.52%)
    '    - Xml Docs: 47.14%
    ' 
    ...
    '     Module Polynomial
    ' 
    '         Function: dictEquals, evalPoly, (+2 Overloads) Factor, factorLinearRoots, factorMultivariate
    '                   factorUnivariate, gcd, halfExp, inferVar, isMultiPoly
    '                   isSquareMono, IsUnivariatePolynomial, monoToExpr, parseMultiTerm, parsePoly
    '                   polyGCD, polyIsZero, polyMultiply, PolynomialDivide, PolynomialGCD
    '                   PolynomialMultiply, PolynomialRemainder, squareRootMono, toExpr, trimZero
    '                   tryDiffSquares, trySquareTrinomial
    ' 
    '         Sub: addMultiFactors, parseTerm, polyDivide
    '         Class MonoTerm
    ' 
    ' 
    ' 

...
Module Module1
    ...
    Sub Main()
        Dim exp As LambdaExpression = LambdaExpression.FromMathML("E:\GCModeller\src\runtime\sciBASIC#\Data_science\Mathematica\Math\MathLambda\mathML.xml".ReadAllText)

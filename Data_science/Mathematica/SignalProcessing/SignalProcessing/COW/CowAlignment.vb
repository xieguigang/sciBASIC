#Region "Microsoft.VisualBasic::3ceb8712bc2d3d15af3ba1a65834ae7c, Data_science\Mathematica\SignalProcessing\SignalProcessing\COW\CowAlignment.vb"
...
#Region "Slack parameter set"
            ...
            For i = 0 To segmentNumber - 1
                ...
                ElseIf borderLimit = BorderLimit.Gaussian Then
                    ...
                    slack.Add(CInt(gaussianFunc.Gaussian(
                              A:=maxSlack - minSlack,
                              mu:=segmentNumber / 2,

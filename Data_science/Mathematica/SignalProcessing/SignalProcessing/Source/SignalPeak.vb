#Region "Microsoft.VisualBasic::f2af3834ca7ced8cb27c092e7cc82e84, Data_science\Mathematica\SignalProcessing\SignalProcessing\Source\SignalPeak.vb"
...
Namespace Source
    ...
    Public Class SignalPeak
        ...
        Public Function GetSignalData(dt As Double, Optional scale As Double = 1.5) As signalData
            ...
            Do While xi < right
                tick.Add((xi + offset, gaussianFunc.Gaussian(xi, max_intensity, center, width)))
                xi += dt
            Loop
        ...
        Public Function GetSignalData(x As Double()) As Double()
            ...
            Dim y As Double() = gaussianFunc.Gaussian(x, max_intensity, center, width)
            Return y
        End Function

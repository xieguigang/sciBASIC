...
Namespace System
    ...
    Public Module NumberExtension
        ...
        Public Function LeadingZeros(ByVal x As Integer) As Integer 'compile time constant
            ...
            x = (x >> 4) + x And &H0f0f0f0F
            x += x >> 8
            x += x >> 16
            Return numIntBits - (x And &H0000003F) 'subtract # of 1s from 32
        End Function
        ...
        Private LN2_H As Double = 0.6931471803691238 ' Long bits 0x3fe62e42fee00000L.
        Private LN2_L As Double = 1.9082149292705877e-10 ' Long bits 0x3dea39ef35793c76L.
        ...
        Private EXPM1_Q1 As Double = -3.33333333333331316428e-02 ' Long bits  0xbfa11111111110f4L
        Private EXPM1_Q2 As Double = 1.58730158725481460165e-03 ' Long bits  0x3f5a01a019fe5585L
        Private EXPM1_Q3 As Double = -7.93650757867487942473e-05 ' Long bits  0xbf14ce199eaadbb7L
        Private EXPM1_Q4 As Double = 4.00821782732936239552e-06 ' Long bits  0x3ed0cfca86e65239L
        Private EXPM1_Q5 As Double = -2.01099218183624371326e-07 ' Long bits  0xbe8afdb76e09c32dL
        ...
        Public Function Expm1(ByVal x As Double) As Double
            ...
            If h_bits >= &H4043687aL Then        ' if |x| >= 56 * ln(2)
                If h_bits >= &H40862e42L Then    ' if |x| >= EXP_LIMIT_H
                    If h_bits >= &H7ff00000L Then
                        If (h_bits And &H000fffffL Or l_bits And &HffffffffL) <> 0 Then
            ...
            Else
                ...
                If k < 20 Then
                    ...
                    h_bits = CULng(&H3ff00000L - (&H00200000L >> k))
                    l_bits = GetLowDWord(bits)
        ...
        Private Function GetLowDWord(ByVal x As Long) As ULong
            Return x And &H00000000ffffffffL
        End Function

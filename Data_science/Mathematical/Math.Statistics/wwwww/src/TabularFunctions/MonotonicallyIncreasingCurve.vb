...
Namespace TabularFunctions
	...
	Public Class MonotonicallyIncreasingCurve
		...
		Public Overrides Function GetXValues() As List(Of Double?)
			Return _X
		End Function
		Public Overrides Function GetYValues() As List(Of Double?) Implements ISampleDeterministically.GetYValues
			Return _Y
		End Function
		...
		End Function
		Public Overrides Function GetYFromX(ByVal x As Double) As Double Implements ISampleDeterministically.GetYFromX
		...
		Public Overrides Function Validate() As List(Of TabularFunctionError)
			...
			Return output
		End Function
		Public Overrides Function GetYFromX(ByVal x As Double, ByVal probability As Double) As Double Implements ISampleWithUncertainty.GetYFromX
			'Basic functionality will return GetYFromX(double x).  MonotonicallyIncreasingCurveUncertain will override this method.
			Return GetYFromX(x)
		End Function
		Public Overrides Function GetYValues(ByVal probability As Double) As List(Of Double?) Implements ISampleWithUncertainty.GetYValues
			'Basic functionality will return _Y.  MonotonicallyIncreasingCurveUncertain will override this method.
			Return _Y
		End Function
		Public Overrides Function GetYDistributions() As List(Of Distributions.ContinuousDistribution) Implements ISampleWithUncertainty.GetYDistributions
			...
			Return output
		End Function
		Public Overrides Function CurveSample(ByVal probability As Double) As ISampleDeterministically Implements ISampleWithUncertainty.CurveSample

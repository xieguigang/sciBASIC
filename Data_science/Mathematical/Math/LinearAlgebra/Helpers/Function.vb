#Region "Microsoft.VisualBasic::4dcef08085ee54b8c6f474790db7ded1, ..\sciBASIC#\Data_science\Mathematical\Math\LinearAlgebra\Helpers\Function.vb"
...
'                {"abs", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Abs)},
'                {"acos", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Acos)},
'                {"asin", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Asin)},
'                {"atan", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Atan)},
'                {"atan2", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, b, AddressOf Math.Atan2)},
'                {"bigmul", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, b, AddressOf Math.BigMul)},
'                {"ceiling", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Ceiling)},
'                {"cos", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Cos)},
'                {"cosh", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Cosh)},
'                {"exp", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Exp)},
'                {"floor", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Floor)},
'                {"ieeeremainder", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, b, AddressOf Math.IEEERemainder)},
'                {"log", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Log)},
'                {"log10", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Log10)},
'                {"max", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, b, AddressOf Math.Max)},
'                {"min", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, b, AddressOf Math.Min)},
'                {"pow", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, b, AddressOf Math.Pow)},
'                {"round", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Round)},
'                {"sign", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Sign)},
'                {"sin", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Sin)},
'                {"sinh", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Sinh)},
'                {"sqrt", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Sqrt)},
'                {"tan", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Tan)},
'                {"tanh", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Tanh)},
'                {"truncate", Function(a As MATRIX, b As MATRIX) MatrixFunction(a, AddressOf Math.Truncate)},

...
Module DEBUG
    ...
    Public Sub scatterWithAnnotation()
        Dim s As New SerialData With {
            ...
            .title = "223 - legend",
            .width = 3,
            .pts = {New PointData With {.pt = New PointF(0.1, 2)}, New PointData With {.pt = New PointF(2, 20)}, New PointData With {.pt = New PointF(5, 12)}},
            .annotations = {New Annotation With {.Font = CSSFont.Win10Normal, .Legend = LegendStyles.Pentacle, .Text = "就是这", .X = 2}}
        }

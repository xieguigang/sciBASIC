...
Module Module1
    ...
    Sub alignment()
        ...
        Dim qdata = query.Split.Select(Function(s) s.Split(","c)).ToDictionary(Function(m) Val(m(0)), Function(v) Val(v(1)) * 100)
        Dim sdata = subject.Split.Select(Function(s) s.Split(","c)).ToDictionary(Function(m) Val(m(0)), Function(v) Val(v(1)) * 100)

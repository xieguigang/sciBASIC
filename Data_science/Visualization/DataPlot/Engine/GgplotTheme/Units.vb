#Region "Microsoft.VisualBasic::3a9603b09d4a30ecac86617b50f5b48b, Data_science\Visualization\DataPlot\Engine\GgplotTheme\Units.vb"
    ...
    '   Total Lines: 642
    '    Code Lines: 462 (71.96%)
    ' Comment Lines: 103 (16.04%)
    '    - Xml Docs: 75.73%
    ' 
    ...
    '         Function: [Char], Clone, Cm, CompareTo, Equals
    '                   GetHashCode, Inch, IsNull, IsRelative, Lines
    '                   Mm, Npc, Null, Parse, Pt
    '                   Px, Rel, ResolveRelative, StringToUnitType, ToString
    '                   UnitTypeToString
    ' 
    '     Class Margin
    ' 
    ...
    '         Function: Clone, Parse, ToString
    ' 
    '     Class CanvasContext
    ' 
    '         Properties: BaseFontSizePt, HeightPx, LineHeight, Ppi, WidthPx
    ' 
    '         Constructor: (+2 Overloads) Sub New
    '         Function: Clone
    ' 
    ...
    '         Function: MarginToPixels, PtToPx, PxToPt, ToPixels, ToPixelsX
    '                   ToPixelsY
    ' 
    ' 
    ' /********************************************************************************/

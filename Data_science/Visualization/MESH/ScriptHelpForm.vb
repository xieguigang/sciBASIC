#Region "Microsoft.VisualBasic::3be7259db0956f89fd78c592c2eaff3c, Data_science\Visualization\MESH\ScriptHelpForm.vb"
    ...
    '   Total Lines: 520
    '    Code Lines: 432 (83.08%)
    ' Comment Lines: 38 (7.31%)
    '    - Xml Docs: 13.16%
    ' 
    '   Blank Lines: 50 (9.62%)
    '     File Size: 25.60 KB
    ...
    ' Class ScriptHelpForm
    ' 
    '     Constructor: (+1 Overloads) Sub New
    ' 
    '     Function: AllNodes, Code, Esc, FnTable, Html
    '               Row
    ' 
    '     Sub: BuildTree, InitializeComponent, LoadHelpTopics, ShowTopic, TreeView1_AfterSelect

#Region "Microsoft.VisualBasic::da22788ecdaa4a65101b86bf9314ebc4, Data_science\Visualization\Plots\BarPlot\Plots\PlotAlignmentGroup.vb"
        ...
        Private Sub DrawTextLabels(g As IGraphics, ymid As Double,
            ...
            For Each part As Signal In query
                For Each o As (x#, value#) In part.signals
                    ...
                    If displayX AndAlso ((o.value / yrange.Max >= labelPlotStrength) OrElse checkHighlight.yes) Then

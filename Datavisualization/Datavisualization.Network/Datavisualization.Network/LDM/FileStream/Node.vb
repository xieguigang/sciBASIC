...
Namespace FileStream
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class Node : Implements Microsoft.VisualBasic.ComponentModel.Collection.Generic.IDEnumerable
        Implements INode
        ...
        ''' </summary>
        ''' <returns></returns>
        Public Overridable Property Identifier As String Implements Microsoft.VisualBasic.ComponentModel.Collection.Generic.IDEnumerable.Identifier, INode.Identifer
        ''' <summary>
        ''' 这个节点的类型的定义
        ''' </summary>
        ''' <returns></returns>

#Region "Microsoft.VisualBasic::3fe3825ce91379f8d46957e700a3771c, ..\sciBASIC#\Microsoft.VisualBasic.Architecture.Framework\Extensions\Collection\Which.vb"
...
Public NotInheritable Class Which
    ...
    ''' <returns></returns>
    Public Shared Iterator Function [True](Of T)(array As IEnumerable(Of T), condi As Func(Of T, Boolean)) As IEnumerable(Of Integer)
        Dim i%

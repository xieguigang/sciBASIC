...
Public Class ColorMap
    ...
    Public ReadOnly Property ColorMaps As Dictionary(Of String, MapsFunc) = New Dictionary(Of String, MapsFunc) From {
 _
    ...
    Public Shared Function ColorSequence(Maps As ColorMap.MapsFunc, map As ColorMap, Optional min As Integer = 0) As Color()
    ...
    Shared ReadOnly __default As ColorMap = New ColorMap(64)

    <ExportAPI("Color.Sequence")>
    Public Shared Function ColorSequence(min As Integer, Optional name As String = "Jet") As Color()
        Dim maps As MapsFunc = ColorMap.__default.GetMaps(name)
        Return ColorMap.ColorSequence(maps, __default, min)
    End Function

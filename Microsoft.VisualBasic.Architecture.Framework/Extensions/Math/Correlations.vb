...
Public Module Beta
    ...
    Public Function betai(a As Double, b As Double, x As Double) As Double
        ...
        If x < 0.0 OrElse x > 1.0 Then
            Throw New System.ArgumentException($"Bad x:={x} in routine betai")
        End If
        If x = 0.0 OrElse x = 1.0 Then
            bt = 0.0
        Else
    ...
    Private Function gammln(xx As Double) As Double
        ...
        Dim cof As Double() = New Double(5) {76.1800917294715, -86.5053203294168, 24.0140982408309, -1.23173957245015, 0.00120865097386618, -0.000005395239384953}
        Dim j As Integer
    ...
    Private Function betacf(a As Double, b As Double, x As Double) As Double
        ...
        Dim aa As Double, c As Double, d As Double, del As Double, h As Double, qab As Double,
            qam As Double, qap As Double
        ...
        Next
        If m > MAXIT Then
            Throw New System.ArgumentException($"a:={a} or b:={b} too big, or MAXIT too small in betacf")
        End If
        Return h
    End Function

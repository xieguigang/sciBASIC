#Region "Microsoft.VisualBasic::591c773d0f3969668d5122cbea866849, ..\VisualBasic_AppFramework\Microsoft.VisualBasic.Architecture.Framework\SoftwareToolkits\ChangeLog.vb"
...
Public Class ChangeLog : Inherits Microsoft.VisualBasic.ComponentModel.ITextFile
    ...
    Public Class UpdateInformation
        ...
        Public Overrides Function ToString() As String
            ...
            Call sBuilder.AppendLine(New String("=", 200))
            ...
            Call sBuilder.AppendLine()
            Call sBuilder.AppendLine(New String("-", 100))
            Call sBuilder.AppendLine()

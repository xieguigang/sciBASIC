...
Public Module __DEBUG_MAIN
    ...
    Function Main() As Integer
        ...
        Dim model = Microsoft.VisualBasic.CommandLine.SharedORM.CommandLineModel("/command1 /param1 <value1> /param2 <value2> [/boolean1 /boolean2 /opt <blabla, default=value233>]")

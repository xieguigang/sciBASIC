#Region "Microsoft.VisualBasic::c71f71c987e9856fa97cc564224a833b, ..\VisualBasic_AppFramework\Microsoft.VisualBasic.Architecture.Framework\Tools\Network\Tcp\Persistent\MessagePushServices\User.vb"
...
#End If
        ...
        Public Function SendMessage(Message As RequestStream) As Boolean
            ...
            Else
                Return System.Text.Encoding.UTF8.GetString(bytesData).getBoolean
            End If
        End Function
        ...
        Public Function SendMessage(Message As RequestStream, CA As SSL.Certificate, Optional isPublicToken As Boolean = False) As Boolean
            ...
            If RequestStream.IsAvaliableStream(byteData) Then
                ...
                Else
                    Return CA.DecryptString(Message.GetUTF8String).getBoolean
                End If

                Return Message.GetUTF8String.getBoolean
            Else
                Return System.Text.Encoding.UTF8.GetString(byteData).getBoolean
            End If
        End Function

Friend Class UpdatesEditor : Implements ComponentModel.ITextFile.IDocumentEditor
    ...
    Public Function Save(Optional FilePath As String = "", Optional Encoding As System.Text.Encoding = Nothing) As Boolean Implements ComponentModel.ITextFile.IDocumentEditor.Save
        Throw New NotImplementedException
    End Function
End Class
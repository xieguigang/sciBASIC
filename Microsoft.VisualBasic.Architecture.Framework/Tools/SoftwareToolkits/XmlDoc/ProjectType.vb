...
Public Class ProjectType
	...
	Public Sub ExportMarkdownFile(folderPath As [String], pageTemplate As [String])
		...
		Dim text As [String] = [String].Format(vbCr & vbLf & "# {0}" & vbCr & vbLf & "_namespace: [{1}](N{1}.md)_" & vbCr & vbLf & vbCr & vbLf & "{2}" & vbCr & vbLf & vbCr & vbLf & "{3}" & vbCr & vbLf & vbCr & vbLf & "{4}" & vbCr & vbLf, Me.Name, Me.[Namespace].Path, CleanText(Me.m_summary), methodList.ToString(), propertyList.ToString())

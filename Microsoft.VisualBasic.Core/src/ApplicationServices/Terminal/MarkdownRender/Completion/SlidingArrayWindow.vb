...
Friend NotInheritable Class SlidingArrayWindow
    ...
    Public ReadOnly Property SelectedIndexInAllItems() As Integer
        Get
            Return selectedIndex
        End Get
    End Property
    Public ReadOnly Property SelectedIndexInVisibleItems() As Integer
        Get
    ...
    Private Sub UpdateVisibleItems()
        ...
        Dim count = std.Min(windowLength, AllItemsCount)

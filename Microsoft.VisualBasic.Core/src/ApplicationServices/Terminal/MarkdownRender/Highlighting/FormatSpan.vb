...
Public Structure FormatSpan
	...
	Public Function Offset(ByVal offset_Conflict As Integer) As FormatSpan
		Return New FormatSpan(Start + offset_Conflict, Length, Formatting)
	End Function
	...
	Public Function WithLength(ByVal length_Conflict As Integer) As FormatSpan
		Return New FormatSpan(Start, length_Conflict, Formatting)
	End Function
	...
	Public Function Equals(ByVal other As FormatSpan) As Boolean
		...
		Return Span = other.Span AndAlso Formatting.Equals(other.Formatting)
	End Function
End Structure
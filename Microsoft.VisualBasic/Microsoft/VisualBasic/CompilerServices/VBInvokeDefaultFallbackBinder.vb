...
Namespace Microsoft.VisualBasic.CompilerServices
    Friend Class VBInvokeDefaultFallbackBinder
        ...
        Public Overrides Function Equals(_other As Object) As Boolean
            Dim binder As VBInvokeDefaultFallbackBinder = TryCast(_other, VBInvokeDefaultFallbackBinder)
        ...
        Public Overrides Function FallbackGetIndex(target As DynamicMetaObject, packedArgs As DynamicMetaObject(), errorSuggestion As DynamicMetaObject) As DynamicMetaObject
            ...
            Dim right As Expression = Expression.Call(GetType(NewLateBinding).GetMethod("FallbackInvokeDefault2"), target.Expression, Expression.Assign(expression2, Expression.NewArrayInit(GetType(Object), args)), Expression.Constant(argNames, GetType(String())), Expression.Constant(Me._reportErrors))
        ...
        Public Overrides Function GetHashCode() As Integer
            Return ((VBInvokeDefaultFallbackBinder._hash Xor MyBase.CallInfo.GetHashCode) Xor Me._reportErrors.GetHashCode)
        End Function

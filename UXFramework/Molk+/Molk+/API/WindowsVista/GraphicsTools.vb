...
Public Module GraphicsTools
    ...
    Public Function CreateRoundRectangle(rectangle As Rectangle, radius As Integer) As GraphicsPath
    ...
    Public Function CreateTopRoundRectangle(rectangle As Rectangle, radius As Integer) As GraphicsPath
        Dim path As New GraphicsPath()
    ...
    Public Function CreateBottomRoundRectangle(rectangle As Rectangle, radius As Integer) As GraphicsPath
        Dim path As New GraphicsPath()

...
Namespace Renderer
    ...
    Public Class CheckBox
        ...
        Public Shared Sub drawBox(ByVal g As Graphics, ByVal x As Integer, ByVal y As Integer,
        Optional ByVal size As Integer = 14, Optional ByVal enabled As Boolean = True,
        ...
        ''' <param name="enabled">Determine whether checkbox is enabled.</param>
        ''' <param name="hLited">Determine whether checkbox is highlited.</param>
        Public Shared Sub drawBox(ByVal g As Graphics, ByVal p As Point,
        Optional ByVal size As Integer = 14, Optional ByVal enabled As Boolean = True,
        Optional ByVal hLited As Boolean = False)
        ...
        ''' <param name="enabled">Determine whether checkbox is enabled.</param>
        ''' <param name="hLited">Determine whether checkbox is highlited.</param>
        Public Shared Sub drawBox(ByVal g As Graphics, ByVal rect As Rectangle,
        Optional ByVal size As Integer = 14, Optional ByVal enabled As Boolean = True,
        Optional ByVal hLited As Boolean = False)
        ...
        ''' <param name="enabled">Determine whether checkbox is enabled.</param>
        Public Shared Sub drawCheck(ByVal g As Graphics, ByVal x As Integer, ByVal y As Integer,
        Optional ByVal state As CheckState = CheckState.Checked,
        ...
        ''' <param name="size">Size of the check.</param>
        ''' <param name="enabled">Determine whether checkbox is enabled.</param>
        Public Shared Sub drawCheck(ByVal g As Graphics, ByVal p As Point,
        Optional ByVal state As CheckState = CheckState.Checked,
        Optional ByVal size As Integer = 8, Optional ByVal enabled As Boolean = True)
        ...
        ''' <param name="size">Size of the check.</param>
        ''' <param name="enabled">Determine whether checkbox is enabled.</param>
        Public Shared Sub drawCheck(ByVal g As Graphics, ByVal rect As Rectangle,
        Optional ByVal state As CheckState = CheckState.Checked,
        Optional ByVal size As Integer = 8, Optional ByVal enabled As Boolean = True)
            Dim x As Integer = rect.X + ((rect.Width - size) / 2)
        ...
        Public Shared Sub drawCheckBox(ByVal g As Graphics, ByVal x As Integer, ByVal y As Integer,
        Optional ByVal state As CheckState = CheckState.Checked,
        Optional ByVal size As Integer = 14, Optional ByVal enabled As Boolean = True,
        Optional ByVal hLited As Boolean = False)
            If size > 8 Then
        ...
        ''' <param name="hLited">Determine whether checkbox is highlited.</param>
        ''' <remarks>Minimum value of size is 8.</remarks>
        Public Shared Sub drawCheckBox(ByVal g As Graphics, ByVal p As Point,
        Optional ByVal state As CheckState = CheckState.Checked,
        Optional ByVal size As Integer = 14, Optional ByVal enabled As Boolean = True,
        Optional ByVal hLited As Boolean = False)
            If size > 8 Then
        ...
        ''' <param name="hLited">Determine whether checkbox is highlited.</param>
        ''' <remarks>Minimum value of size is 8.</remarks>
        Public Shared Sub drawCheckBox(ByVal g As Graphics, ByVal rect As Rectangle,
        Optional ByVal state As CheckState = CheckState.Checked,
        Optional ByVal size As Integer = 14, Optional ByVal enabled As Boolean = True,
        Optional ByVal hLited As Boolean = False)
            If size > 8 Then

#Region "Microsoft.VisualBasic::5b0d1a5429c442e1e118e53a1a256396, cuda\ILCuda\IL2Cuda\IlCudaKernel.vb"
    ...
    '   Total Lines: 420
    '    Code Lines: 279 (66.43%)
    ' Comment Lines: 57 (13.57%)
    '    - Xml Docs: 40.35%
    ' 
    '   Blank Lines: 84 (20.00%)
    '     File Size: 19.42 KB


    '     Class IlCudaKernel
    ' 
    '         Properties: CountParameterName, DeviceFunctionName, IndexMode, MethodName, Name
    '                     OutputParameterName, Source, Syntax
    ' 
    '         Function: ToString
    ' 
    '         Sub: (+2 Overloads) Launch, Register
    ' 
    '     Module IlCudaTranslator
    ' 
    '         Function: BuildSource, IndexParameterNames, InferIndexMode, IsPureScalar, IsPureScalarExpr
    '                   IsPureScalarStatement, IsScalarWrapped, ParameterNameOf, Translate
    ' 
    ' 
    ' /********************************************************************************/

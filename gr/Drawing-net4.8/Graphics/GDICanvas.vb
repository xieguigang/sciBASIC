#Region "Microsoft.VisualBasic::9f6dacd6e186c800ff51910e2e2ef2a2, gr\Drawing-net4.8\Graphics\GDICanvas.vb"
    ...
    '   Total Lines: 2543
    '    Code Lines: 721 (28.35%)
    ' Comment Lines: 1624 (63.86%)
    '    - Xml Docs: 12.99%
    ' 
    '   Blank Lines: 198 (7.79%)
    '     File Size: 87.54 KB
...
#If NET8_0_OR_GREATER Then
        Call Graphics.DrawImage(GDIPlusImage.CTypeGDIPlusImage(image), rect)
#Else
...
#If NET8_0_OR_GREATER Then
        Call Graphics.DrawImage(GDIPlusImage.CTypeGDIPlusImage(image), destPoints)
#Else
...
#If NET8_0_OR_GREATER Then
        Call Graphics.DrawImage(GDIPlusImage.CTypeGDIPlusImage(image), point.PointF)
#Else
...
#If NET8_0_OR_GREATER Then
        Call Graphics.DrawImage(GDIPlusImage.CTypeGDIPlusImage(image), point)
#Else
        Call Graphics.DrawImage(image, point)
#End If
    End Sub
...
#If NET8_0_OR_GREATER Then
        Call Graphics.DrawImage(GDIPlusImage.CTypeGDIPlusImage(image), CSng(x), CSng(y))
#Else
...
#If NET8_0_OR_GREATER Then
        Call Graphics.DrawImage(GDIPlusImage.CTypeGDIPlusImage(image), x, y)
#Else
        Call Graphics.DrawImage(image, x, y)
#End If
    End Sub
...
#If NET8_0_OR_GREATER Then
        Call Graphics.DrawImage(GDIPlusImage.CTypeGDIPlusImage(image), x, y, width, height)
#Else
...
#If NET8_0_OR_GREATER Then
        Call Graphics.DrawImageUnscaled(GDIPlusImage.CTypeGDIPlusImage(image), rect)
#Else
...
#If NET8_0_OR_GREATER Then
        Call Graphics.DrawImageUnscaled(GDIPlusImage.CTypeGDIPlusImage(image), point)
#Else
...
#If NET8_0_OR_GREATER Then
        Call Graphics.DrawImageUnscaled(GDIPlusImage.CTypeGDIPlusImage(image), x, y)
#Else
...
#If NET8_0_OR_GREATER Then
        Call Graphics.DrawImageUnscaled(GDIPlusImage.CTypeGDIPlusImage(image), x, y, width, height)
#Else
...
#If NET8_0_OR_GREATER Then
        Call Graphics.DrawImageUnscaledAndClipped(GDIPlusImage.CTypeGDIPlusImage(image), rect)
#Else

#Region "Microsoft.VisualBasic::fe9a586d7f67124f10cd69e32501e4e0, gr\Landscape\Max3DS\Max3DSParser.vb"
    ...
    '   Total Lines: 584
    '    Code Lines: 343 (58.73%)
    ' Comment Lines: 143 (24.49%)
    '    - Xml Docs: 62.24%
    ' 
    '   Blank Lines: 98 (16.78%)
    '     File Size: 23.77 KB
    ...
    '     Module Max3DSParser
    ' 
    '         Function: BuildSceneModel, HasSubChunks, (+2 Overloads) Parse3DS, ParseMainChunk, ParseMaterialBlock
    '                   ParseMeshBlock, ParseObjectBlock, ReadChunk, ReadChunkTree, ReadColorByte
    '                   ReadColorFloat, ReadNullTerminatedString
    ' 
    '         Sub: ApplyLocalMatrix, ParseEdit3DS, ParseMaterialColor, ParseTextureMap, ReadFaceList
    '              ReadLocalMatrix, ReadMaterialFaceMap, ReadTextureVertices, ReadVertexList
    ' 
    ' 
    ' /********************************************************************************/

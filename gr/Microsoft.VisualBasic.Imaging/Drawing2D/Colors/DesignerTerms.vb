#Region "Microsoft.VisualBasic::db847d90da63fb3c437862b197cbcf79, gr\Microsoft.VisualBasic.Imaging\Drawing2D\Colors\DesignerTerms.vb"
...
All of the color schema in ColorBrewer system have several levels, which could be use expression pattern
such as 'schema_name:c[level]' for get colors from the color designer, examples as 'YlGnBu:c6' will 
generate a color sequence which have 6 colors that comes from the YlGnBu pattern.
...
1. Sequential schemes are suited to ordered data that progress from low to high. Lightness steps dominate the 
   ...
   All of the colors terms in Sequential schemes have levels from 3 to 9, schema name terms includes:
...
2. Qualitative schemes do not imply magnitude differences between legend classes, and hues are used to create the 
...
3. Diverging schemes put equal emphasis on mid-range critical values and extremes at both ends of the data range. 
   ...
   All of the colors terms in Sequential schemes have levels from 3 to 11, schema name terms includes:

                ...
                For i = 0 To Xres - 1
                    ...
                    Select Case pattern
                        Case 0, 1, 4, 32, 128, 5, 132, 160, 33, 129, 36, 133, 164, 161, 37, 165
                            dp(dpIdx) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(3), w(1))
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(1), w(5))
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(7), w(3))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(5), w(7))
                            Exit Select
                        Case 2, 34, 130, 162
                            dp(dpIdx) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(0), w(3))
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(2), w(5))
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(7), w(3))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(5), w(7))
                            Exit Select
                        Case 16, 17, 48, 49
                            dp(dpIdx) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(3), w(1))
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(2), w(1))
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(7), w(3))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(8), w(7))
                            Exit Select
                        Case 64, 65, 68, 69
                            dp(dpIdx) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(3), w(1))
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(1), w(5))
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(6), w(3))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(8), w(5))
                            Exit Select
                        Case 8, 12, 136, 140
                            dp(dpIdx) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(0), w(1))
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(1), w(5))
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(6), w(7))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(5), w(7))
                            Exit Select
                        Case 3, 35, 131, 163
                        ...
                        Case 6, 38, 134, 166
                            dp(dpIdx) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(0), w(3))
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(5))
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(7), w(3))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(5), w(7))
                            Exit Select
                        Case 20, 21, 52, 53
                        ...
                        Case 144, 145, 176, 177
                            ...
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(2), w(1))
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(7), w(3))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(7))
                            Exit Select
                        Case 192, 193, 196, 197
                            dp(dpIdx) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(3), w(1))
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(1), w(5))
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(6), w(3))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(5))
                            Exit Select
                        Case 96, 97, 100, 101
                            dp(dpIdx) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(3), w(1))
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(1), w(5))
                        ...
                        Case 40, 44, 168, 172
                            dp(dpIdx) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(0), w(1))
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(1), w(5))
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix3To1(w(4), w(7))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(5), w(7))
                            Exit Select
                        Case 9, 13, 137, 141
                        ...
                        Case 18, 50
                            ...
                            If HqxScaling.Hqx.diff(w(1), w(5), [trY], trU, trV, trA) Then
                                dp(dpIdx + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(2))
                            Else
                                dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(1), w(5))
                            End If
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(7), w(3))
                        ...
                        Case 80, 81
                            ...
                            If HqxScaling.Hqx.diff(w(5), w(7), [trY], trU, trV, trA) Then
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(8))
                            Else
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(5), w(7))
                            End If
                            Exit Select
                        Case 72, 76
                            ...
                            If HqxScaling.Hqx.diff(w(7), w(3), [trY], trU, trV, trA) Then
                                dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix3To1(w(4), w(6))
                            Else
                                dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(7), w(3))
                            End If
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(8), w(5))
                        ...
                        Case 10, 138
                            If HqxScaling.Hqx.diff(w(3), w(1), [trY], trU, trV, trA) Then
                                dp(dpIdx) = HqxScaling.Interpolation.Mix3To1(w(4), w(0))
                            Else
                                dp(dpIdx) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(3), w(1))
                            End If
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(2), w(5))
                        ...
                        Case 19, 51
                            If HqxScaling.Hqx.diff(w(1), w(5), [trY], trU, trV, trA) Then
                                ...
                                dp(dpIdx + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(2))
                            Else
                                dp(dpIdx) = HqxScaling.Interpolation.Mix4To2To1(w(4), w(1), w(3))
                                dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To3To3(w(4), w(1), w(5))
                            End If
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(7), w(3))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(8), w(7))
                            Exit Select
                        Case 146, 178
                            ...
                            Else
                                dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To3To3(w(4), w(1), w(5))
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix4To2To1(w(4), w(5), w(7))
                            End If
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(7), w(3))
                            Exit Select
                        Case 84, 85
                            ...
                            If HqxScaling.Hqx.diff(w(5), w(7), [trY], trU, trV, trA) Then
                                ...
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(8))
                            Else
                                dp(dpIdx + 1) = HqxScaling.Interpolation.Mix4To2To1(w(4), w(5), w(1))
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To3To3(w(4), w(5), w(7))
                            End If
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(6), w(3))
                            Exit Select
                        Case 112, 113
                            ...
                            If HqxScaling.Hqx.diff(w(5), w(7), [trY], trU, trV, trA) Then
                                ...
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(8))
                            Else
                                dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix4To2To1(w(4), w(7), w(3))
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To3To3(w(4), w(5), w(7))
                            End If
                            Exit Select
                        Case 200, 204
                            ...
                            If HqxScaling.Hqx.diff(w(7), w(3), [trY], trU, trV, trA) Then
                                ...
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(5))
                            Else
                                dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To3To3(w(4), w(7), w(3))
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix4To2To1(w(4), w(7), w(5))
                            End If
                            Exit Select
                        Case 73, 77
                            If HqxScaling.Hqx.diff(w(7), w(3), [trY], trU, trV, trA) Then
                                ...
                                dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix3To1(w(4), w(6))
                            Else
                                dp(dpIdx) = HqxScaling.Interpolation.Mix4To2To1(w(4), w(3), w(1))
                                dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To3To3(w(4), w(7), w(3))
                            End If
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(1), w(5))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(8), w(5))
                        ...
                        Case 42, 170
                            If HqxScaling.Hqx.diff(w(3), w(1), [trY], trU, trV, trA) Then
                                ...
                                dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix3To1(w(4), w(7))
                            Else
                                dp(dpIdx) = HqxScaling.Interpolation.Mix2To3To3(w(4), w(3), w(1))
                                dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix4To2To1(w(4), w(3), w(7))
                            End If
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(2), w(5))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(5), w(7))
                            Exit Select
                        Case 14, 142
                            ...
                            Else
                                dp(dpIdx) = HqxScaling.Interpolation.Mix2To3To3(w(4), w(3), w(1))
                                dp(dpIdx + 1) = HqxScaling.Interpolation.Mix4To2To1(w(4), w(1), w(5))
                            End If
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(6), w(7))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(5), w(7))
                            Exit Select
                        ...
                        Case 58
                            If HqxScaling.Hqx.diff(w(3), w(1), [trY], trU, trV, trA) Then
                                dp(dpIdx) = HqxScaling.Interpolation.Mix3To1(w(4), w(0))
                            Else
                                dp(dpIdx) = HqxScaling.Interpolation.Mix6To1To1(w(4), w(3), w(1))
                            End If
                            If HqxScaling.Hqx.diff(w(1), w(5), [trY], trU, trV, trA) Then
                                dp(dpIdx + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(2))
                            Else
                                dp(dpIdx + 1) = HqxScaling.Interpolation.Mix6To1To1(w(4), w(1), w(5))
                            End If
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix3To1(w(4), w(7))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(8), w(7))
                            Exit Select
                        Case 83
                            ...
                            If HqxScaling.Hqx.diff(w(5), w(7), [trY], trU, trV, trA) Then
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(8))
                            Else
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix6To1To1(w(4), w(5), w(7))
                            End If
                            Exit Select
                        Case 92
                            dp(dpIdx) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(0), w(1))
                            ...
                            If HqxScaling.Hqx.diff(w(7), w(3), [trY], trU, trV, trA) Then
                                dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix3To1(w(4), w(6))
                            Else
                                dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix6To1To1(w(4), w(7), w(3))
                            End If
                            If HqxScaling.Hqx.diff(w(5), w(7), [trY], trU, trV, trA) Then
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(8))
                            Else
                        ...
                        Case 237, 233
                            ...
                            If HqxScaling.Hqx.diff(w(7), w(3), [trY], trU, trV, trA) Then
                                dp(dpIdx + dpL) = w(4)
                            Else
                                dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix14To1To1(w(4), w(7), w(3))
                            End If
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(5))
                            Exit Select
                        Case 175, 47
                            If HqxScaling.Hqx.diff(w(3), w(1), [trY], trU, trV, trA) Then
                                dp(dpIdx) = w(4)
                            Else
                                dp(dpIdx) = HqxScaling.Interpolation.Mix14To1To1(w(4), w(3), w(1))
                            End If
                            dp(dpIdx + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(5))
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix3To1(w(4), w(7))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(5), w(7))
                        ...
                        Case 183, 151
                            ...
                            If HqxScaling.Hqx.diff(w(1), w(5), [trY], trU, trV, trA) Then
                                dp(dpIdx + 1) = w(4)
                            Else
                                dp(dpIdx + 1) = HqxScaling.Interpolation.Mix14To1To1(w(4), w(1), w(5))
                            End If
                            dp(dpIdx + dpL) = HqxScaling.Interpolation.Mix2To1To1(w(4), w(7), w(3))
                            dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix3To1(w(4), w(7))
                            Exit Select
                        Case 245, 244
                            ...
                            If HqxScaling.Hqx.diff(w(5), w(7), [trY], trU, trV, trA) Then
                                dp(dpIdx + dpL + 1) = w(4)
                            Else
                                dp(dpIdx + dpL + 1) = HqxScaling.Interpolation.Mix14To1To1(w(4), w(5), w(7))
                            End If
                            Exit Select
                        Case 250
                            dp(dpIdx) = HqxScaling.Interpolation.Mix3To1(w(4), w(0))

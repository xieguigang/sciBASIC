#Region "Microsoft.VisualBasic::704df0d2f8dd6d2ea82cf98f24382d31, sciBASIC#\gr\Microsoft.VisualBasic.Imaging\Drawing2D\HeatMap\RasterScaler.vb"
...
Namespace Drawing2D.HeatMap
    ...
    Public Class RasterScaler : Implements IDisposable
        ...
        Sub New(heatmap As Bitmap, Optional formula As Func(Of Color, Single) = Nothing)
            Me.buffer = BitmapBuffer.FromBitmap(heatmap, ImageLockMode.ReadOnly)
            Me.formula = formula

...
Public Class CssDefaults
	...
	''' </summary>
	Public Shared FontSize As Single = 12F

	''' <summary>
	''' Default font used for the generic 'serif' family
	''' </summary>
	Public Shared FontSerif As String = System.Drawing.FontFamily.GenericSerif.Name

	''' <summary>
	''' Default font used for the generic 'sans-serif' family
	''' </summary>
	Public Shared FontSansSerif As String = System.Drawing.FontFamily.GenericSansSerif.Name
	...
	''' </summary>
	Public Shared FontMonospace As String = System.Drawing.FontFamily.GenericMonospace.Name
End Class

...
Public Class InitialContainer
	Inherits CssBox
	#Region "Fields"
	Private _media_blocks As Dictionary(Of String, Dictionary(Of String, CssBlock))
	Private _documentSource As String
	Private _avoidGeometryAntialias As Boolean
	Private _maxSize As SizeF
	Private _scrollOffset As PointF
	Private _linkRegions As Dictionary(Of CssBox, RectangleF)
	Private _avoidTextAntialias As Boolean
	#End Region
	...
	Public Sub New()
		...
		_media_blocks = New Dictionary(Of String, Dictionary(Of String, CssBlock))()
	...
	Public Property AvoidTextAntialias() As Boolean
		Get
			Return _avoidTextAntialias
		End Get
		Set
			_avoidTextAntialias = value
		End Set
	End Property

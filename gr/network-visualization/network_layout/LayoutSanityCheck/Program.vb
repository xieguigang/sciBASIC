#Region "Microsoft.VisualBasic::4329e0fc15f27ee241c1aec7d5a680bd, gr\network-visualization\network_layout\LayoutSanityCheck\Program.vb"
    ...
    '   Total Lines: 137
    '    Code Lines: 104 (75.91%)
    ' Comment Lines: 2 (1.46%)
    '    - Xml Docs: 0.00%
    ' 
    '   Blank Lines: 31 (22.63%)
    '     File Size: 4.83 KB
    ...
    '     Delegate Sub
    ' 
    '         Sub: RunCircular, RunCircularOptimized, RunRadial, RunSpringEmbedder, RunSpringForce
    '              SanityCheck
    ' 
    ' 
    ' 

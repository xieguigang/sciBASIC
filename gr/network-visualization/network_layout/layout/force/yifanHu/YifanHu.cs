...
//ORIGINAL LINE: @ServiceProvider(service = LayoutBuilder.class) public class YifanHu implements org.gephi.layout.spi.LayoutBuilder
	public class YifanHu : LayoutBuilder
	{

		private readonly YifanHuLayoutUI ui = new YifanHuLayoutUI();
		...
		public override string Name
		{
			get
			{
				return NbBundle.getMessage(typeof(YifanHu), "YifanHu.name");
			}
		}
		...
		private class YifanHuLayoutUI : LayoutUI
		{
			...
			public override string Description
			{
				get
				{
					return NbBundle.getMessage(typeof(YifanHu), "YifanHu.description");
				}
			}

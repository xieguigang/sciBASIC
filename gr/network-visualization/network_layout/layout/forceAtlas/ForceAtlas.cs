...
//ORIGINAL LINE: @ServiceProvider(service = LayoutBuilder.class) public class ForceAtlas implements org.gephi.layout.spi.LayoutBuilder
	public class ForceAtlas : LayoutBuilder
	{

		private readonly ForceAtlasLayoutUI ui = new ForceAtlasLayoutUI();

		public override string Name
		{
			get
			{
				return NbBundle.getMessage(typeof(ForceAtlasLayout), "name");
			}
		}

		public override ForceAtlasLayout buildLayout()
		{
		...
		private class ForceAtlasLayoutUI : LayoutUI
		{
			...
			public override string Description
			{
				get
				{
					return NbBundle.getMessage(typeof(ForceAtlas), "description");
				}
			}

...
namespace org.gephi.layout.plugin.forceAtlas2
{
	...
	/// </summary>
	public class NodesThread : ThreadStart
	{
		...
		private readonly bool barnesHutOptimize;
		private readonly RepulsionForce Repulsion;
		private readonly double barnesHutTheta;
		private readonly double gravity;
		private readonly RepulsionForce GravityForce;
		private readonly double scaling;

		public NodesThread(Node[] nodes, int from, int to, bool barnesHutOptimize, double barnesHutTheta, double gravity, RepulsionForce GravityForce, double scaling, Region rootRegion, RepulsionForce Repulsion)
		{
			this.nodes = nodes;
			this.from = from;
			this.to = to;

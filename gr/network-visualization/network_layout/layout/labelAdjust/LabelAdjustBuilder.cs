...
//ORIGINAL LINE: @ServiceProvider(service = LayoutBuilder.class) public class LabelAdjustBuilder implements org.gephi.layout.spi.LayoutBuilder
	public class LabelAdjustBuilder : LayoutBuilder
	{

		private readonly LabelAdjustLayoutUI ui = new LabelAdjustLayoutUI();

		public override string Name
		{
			get
			{
				return NbBundle.getMessage(typeof(LabelAdjustBuilder), "name");
			}
		}

		public override LabelAdjust buildLayout()
		{
		...
		private class LabelAdjustLayoutUI : LayoutUI
		{
			...
			public override string Description
			{
				get
				{
					return NbBundle.getMessage(typeof(LabelAdjustBuilder), "description");
				}
			}

...
//ORIGINAL LINE: @ServiceProvider(service = LayoutBuilder.class) public class OpenOrdLayoutBuilder implements org.gephi.layout.spi.LayoutBuilder
	public class OpenOrdLayoutBuilder : LayoutBuilder
	{

		private readonly OpenOrdLayoutUI ui = new OpenOrdLayoutUI();

		public override string Name
		{
			get
			{
				return NbBundle.getMessage(typeof(OpenOrdLayoutBuilder), "OpenOrd.name");
			}
		}
		...
		private class OpenOrdLayoutUI : LayoutUI
		{
			...
			public override string Description
			{
				get
				{
					return NbBundle.getMessage(typeof(OpenOrdLayoutBuilder), "OpenOrd.description");
				}
			}

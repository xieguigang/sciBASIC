...
//ORIGINAL LINE: @ServiceProvider(service = LayoutBuilder.class) public class Random implements org.gephi.layout.spi.LayoutBuilder
	public class Random : LayoutBuilder
	{

		private readonly RandomLayoutUI ui = new RandomLayoutUI();

		public override string Name
		{
			get
			{
				return NbBundle.getMessage(typeof(Random), "Random.name");
			}
		}
		...
		private class RandomLayoutUI : LayoutUI
		{
			...
			public override string Description
			{
				get
				{
					return NbBundle.getMessage(typeof(Random), "Random.description");
				}
			}

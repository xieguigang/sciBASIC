...
//ORIGINAL LINE: @ServiceProvider(service = LayoutBuilder.class) public class Rotate implements org.gephi.layout.spi.LayoutBuilder
	public class Rotate : LayoutBuilder
	{

		private readonly RotateLayoutUI ui = new RotateLayoutUI();

		public override RotateLayout buildLayout()
		{
		...
		public override string Name
		{
			get
			{
				return NbBundle.getMessage(typeof(Rotate), "rotate.name");
			}
		}
		...
		private class RotateLayoutUI : LayoutUI
		{
			...
			public override string Description
			{
				get
				{
					return NbBundle.getMessage(typeof(Rotate), "rotate.description");
				}
			}

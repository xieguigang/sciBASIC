...
//ORIGINAL LINE: @ServiceProvider(service = LayoutBuilder.class) public class Contract implements org.gephi.layout.spi.LayoutBuilder
	public class Contract : LayoutBuilder
	{

		private readonly ContractLayoutUI ui = new ContractLayoutUI();

		public override string Name
		{
			get
			{
				return NbBundle.getMessage(typeof(Contract), "contract.name");
			}
		}

		public override ContractLayout buildLayout()
		{
		...
		private class ContractLayoutUI : LayoutUI
		{
			...
			public override string Description
			{
				get
				{
					return NbBundle.getMessage(typeof(Contract), "contract.description");
				}
			}

#Region "Microsoft.VisualBasic::281b83328e132caadbbd8c281a191f46, llm\Agent\ToolCalls\ToolCallProtocol.vb"
    ...
    '   Total Lines: 443
    '    Code Lines: 238 (53.72%)
    ' Comment Lines: 100 (22.57%)
    '    - Xml Docs: 62.00%
    ' 
    ...
    ' 
    '         Function: FormatCallHeader, FormatCallTail, FormatResult, FormatResults, HasCallTerminator
    '                   HasToolCallSignal, ParseArgumentObject, TryExtractToolName, TryParseCalls, Unescape
    ' 
    '         Sub: ParseArguments
    ' 
    ' 

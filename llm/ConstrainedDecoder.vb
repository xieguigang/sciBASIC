#Region "Microsoft.VisualBasic::633867438c30e1b99dc53e9421314858, llm\ConstrainedDecoder.vb"
    ...
    '     Enum JsonState
    ' 
    '         AfterValue, Done, ExpectColon, ExpectKeyOrEnd, ExpectObjectStart
    '         ExpectValue, InBoolean, InEnumValue, InKey, InNumber
    '         InStringValue
    ' 
    ' 
    ' 
    ...
    '  
    ' 
    '     Properties: GeneratedText, IsComplete, LastLegalCharacters, LastLegalTokenCount, LastMaskedTokenCount
    '                 PendingKey, Schema, StateName, Trace, TraceLimit
    ' 
    '     Constructor: (+1 Overloads) Sub New
    ' 
    '     Function: ApplyMask, Capture, ConsumeBoolean, ConsumeInPlace, ConsumeNumber
    '               ConsumeValueStart, CreateProcessor, Escape, Generate, HasNextProperty

...
Namespace org.renjin.hdf5.groups
	...
	Public Class SimpleGroupIndex
	  ...
	  Private links As IList(Of org.renjin.hdf5.message.LinkMessage) = New List(Of org.renjin.hdf5.message.LinkMessage)()

	  Public Sub New(ByVal file As org.renjin.hdf5.Hdf5Data, ByVal messages As IEnumerable(Of org.renjin.hdf5.message.LinkMessage))
		Me.file = file

        ...
        Friend Overrides Sub WriteObjectToPdfFile()
            ...
            If EmbeddedFont Then
                ...
                While Ptr2 >= 0 AndAlso Char.IsDigit(ResourceCode(Ptr2))
                    PdfFontName(Math.Max(Threading.Interlocked.Decrement(Ptr1), Ptr1 + 1)) = Microsoft.VisualBasic.ChrW(Microsoft.VisualBasic.AscW(ResourceCode(Ptr2)) + (Asc("A"c) - Asc("0"c)))
                    Ptr2 -= 1
                End While
            End If

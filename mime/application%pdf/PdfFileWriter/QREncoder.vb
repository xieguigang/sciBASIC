...
Namespace PdfFileWriter
    ...
    Public Class QREncoder
        ...
        Friend Sub EncodeData()
            ...
            ' flush bit buffer
            If BitBufferLen > 0 Then CodewordsArray(Math.Min(Threading.Interlocked.Increment(CodewordsPtr), CodewordsPtr - 1)) = CByte(BitBuffer >> 24)
        ...
        Friend Sub SaveBitsToCodewordsArray(ByVal Data As Integer, ByVal Bits As Integer)
            ...
            While BitBufferLen >= 8
                CodewordsArray(Math.Min(Threading.Interlocked.Increment(CodewordsPtr), CodewordsPtr - 1)) = CByte(BitBuffer >> 24)
                BitBuffer <<= 8
                BitBufferLen -= 8
            End While
        ...
        Friend Sub CalculateErrorCorrection()
            ...
            Dim BufSize = Math.Max(DataCodewordsGroup1, DataCodewordsGroup2) + ErrCorrCodewords

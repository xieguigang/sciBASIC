    ...
    Public Class PdfContentsParser
        ...
        Public Function GetObject() As PdfObject
            ...
            If _parser Is Nothing AndAlso _index < Contents.Streams.Count Then
                _parser = New Parser(New MemoryStream(Contents.Streams(std.Min(Threading.Interlocked.Increment(_index), _index - 1)).ValueAsBytes), True)
            End If
            ...
            While _parser IsNot Nothing
                ...
                If _index < Contents.Streams.Count Then _parser = New Parser(New MemoryStream(Contents.Streams(std.Min(Threading.Interlocked.Increment(_index), _index - 1)).ValueAsBytes), True)
            End While

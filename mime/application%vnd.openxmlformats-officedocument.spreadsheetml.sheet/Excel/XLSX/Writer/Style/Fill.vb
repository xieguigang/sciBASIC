#Region "Microsoft.VisualBasic::858f4491b04162b601168ce5df4aaa5b, mime\application%vnd.openxmlformats-officedocument.spreadsheetml.sheet\Excel\XLSX\Writer\Style\Fill.vb"
    ...
    '   Total Lines: 311
    '    Code Lines: 168 (54.02%)
    ' Comment Lines: 118 (37.94%)
    '    - Xml Docs: 88.98%
    ' 
    '   Blank Lines: 25 (8.04%)
    '     File Size: 14.46 KB
    ...
    ' 
    '         Function: Copy, CopyFill, GetEffectiveFillColor, GetHashCode, GetPatternName
    '                   HasVisibleFill, NormalizeColor, ToString
    ' 

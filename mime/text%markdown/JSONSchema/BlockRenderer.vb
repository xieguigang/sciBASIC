#Region "Microsoft.VisualBasic::398343cb00da41303f4b059d5eec4a35, mime\text%markdown\JSONSchema\BlockRenderer.vb"
    ...
    '   Total Lines: 385
    '    Code Lines: 279 (72.47%)
    ' Comment Lines: 36 (9.35%)
    '    - Xml Docs: 52.78%
    ' 
    '   Blank Lines: 70 (18.18%)
    '     File Size: 16.43 KB


    '     Module BlockRenderer
    ' 
    '         Function: alignMarkdownToken, AlignStyle, HtmlEncode, MinInt, renderBlockquoteHtml
    '                   renderBlockquoteMarkdown, renderDefListHtml, renderDefListMarkdown, renderFootnoteHtml, renderFootnoteMarkdown
    '                   renderLinkHtml, renderLinkMarkdown, renderListHtml, renderListMarkdown, renderMathHtml
    '                   renderMathMarkdown, renderTableHtml, renderTableMarkdown, renderTaskListHtml, renderTaskListMarkdown
    '                   ToHtmlBlock, ToMarkdownBlock
    ' 
    ' 
    ' /********************************************************************************/

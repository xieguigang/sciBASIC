#Region "Microsoft.VisualBasic::628689058f193d9eed05794f093241a1, mime\text%markdown\MarkdownParser.vb"
    ...
    '   Total Lines: 907
    '    Code Lines: 752 (82.91%)
    ' Comment Lines: 59 (6.50%)
    '    - Xml Docs: 30.51%
    ' 
    '   Blank Lines: 96 (10.58%)
    '     File Size: 33.23 KB
    ...
    ' 
    '     Function: CollapseCode, CollectBlockQuote, CollectFence, CollectList, CollectTable
    '               EscapeText, FindParenClose, GetIndent, IndexOfDelim, IsBlockStart
    '               IsTableStart, IsWord, MatchAutoLink, MatchBareUrl, MatchCodeSpan
    '               MatchEmphasis, MatchFence, MatchLink, MatchListItem, MatchStrike
    '               NoLink, Parse, ParseAligns, ParseBlocks, ParseInline
    '               RenderEmphasis, SplitRow, TightenListItem, UnderscoreDelimiter
    ' 
    '     Sub: Flush
    '     Structure FenceInfo
    ' 
    ...
    ' 
    ' 
    '     Structure AutoLinkInfo
    ' 
    ' 
    ' 
    '     Structure EmphasisInfo
    ' 
    ' 
    ' 
    ' 

...
Namespace Exporter.YAML
	Public NotInheritable Class YAMLMappingNode
		...
		Public Sub New(style__1 As MappingStyle)
			Style = style__1
		End Sub
		...
		Friend Overrides Sub Emit(emitter As Emitter)
			...
			For Each kvp As var In m_children
		...
		Public Property Style() As MappingStyle
			...
			End Set
		End Property
		Private m_Style As MappingStyle

		Private ReadOnly m_children As New List(Of KeyValuePair(Of YAMLNode, YAMLNode))()
	End Class
End Namespace

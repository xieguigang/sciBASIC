#Region "Microsoft.VisualBasic::d08c865a733f08e88db64585094034aa, nlp\KnowledgeGraph\KnowledgeGraph.vb"
    ...
    '   Total Lines: 311
    '    Code Lines: 184 (59.16%)
    ' Comment Lines: 87 (27.97%)
    '    - Xml Docs: 83.91%
    ' 
    ...
    ' Class EntityNode
    ' 
    '     Properties: EntityType, Id, Language, Name
    ' 
    '     Function: ToString
    ' 
    ' Class AttributeNode
    ' 
    '     Properties: Category, Id, Name
    ' 
    '     Function: ToString
    ' 
    ' Class KnowledgeGraph
    ' 
    '     Properties: Attributes, Entities, TotalEdges
    ' 
    '     Function: AddAttribute, AddEntity, FindEntity, GetAttribute, GetAttributeCategoryStats
    '               GetAttributeDegree, GetAttributeEntities, GetAttributeName, GetAttributeNames, GetDegreeSequence
    '               GetEntity, GetEntityAttributes, GetEntityDegree, GetEntityName, GetSharedAttributes
    ' 
    '     Sub: AddEdge, AddEntityAttribute
    ' 
    ' /********************************************************************************/

#Region "Microsoft.VisualBasic::89b55d564222ea1bf88062a8cd82c53d, tutorials\MESH\ScriptEditorForm.vb"
    ...
    '   Total Lines: 436
    '    Code Lines: 318 (72.94%)
    ' Comment Lines: 79 (18.12%)
    '    - Xml Docs: 40.51%
    ' 
    '   Blank Lines: 39 (8.94%)
    '     File Size: 19.86 KB
    ...
    ' 
    '     Function: BuildPresetScripts, IsNumericType, LoadDataFrameFile, MakeLineScript, MakeScatter3Script
    '               MakeScript, SampleScript, SanitizeColumnName, ToDoubleArray
    ' 
    '     Sub: InitializeComponent, LoadPresetScripts, PresetSelected, ToolStripButton1_Click, ToolStripButton2_Click

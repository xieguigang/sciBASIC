#Region "Microsoft.VisualBasic::3ebf589d420ee8e15e093cac050501d6, vs_solutions\VBS\src\MakeProject.vb"
    ...
    ' Comment Lines: 41 (11.88%)
    '    - Xml Docs: 70.73%
    ' 
    '   Blank Lines: 69 (20.00%)
    '     File Size: 15.41 KB


    ' Module MakeProject
    ' 
    '     Function: [Run], Build, BuildPackageReferences, BuildProjectModel, BuildReferences
    '               Relative
    ' 
    '     Sub: ApplyMetadata, PrintLine, PrintUsage, SaveProject
    ' 
    ' /********************************************************************************/

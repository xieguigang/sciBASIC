#Region "Microsoft.VisualBasic::c3a385f1b29e3bef0fc64c3bedec5565, vs_solutions\VBS\src\VBScript\IncludeDirective\IncludeResolver.vb"
    ...
    '   Total Lines: 392
    '    Code Lines: 240 (61.22%)
    ' Comment Lines: 69 (17.60%)
    '    - Xml Docs: 81.16%
    ' 
    '   Blank Lines: 83 (21.17%)
    '     File Size: 17.33 KB
    ...
    ' 
    '         Function: Locate, MergeRoots, NormalizeVersionConstraint, Resolve, TryParseNuGet
    ' 
    '         Sub: AddAssembly, ApplyNativeLibraryPath, IncludeNuGet, IncludeScript, ResolveDirective
    '              ResolveSource, ValidateScript
    ' 
    ' 
    ' /********************************************************************************/

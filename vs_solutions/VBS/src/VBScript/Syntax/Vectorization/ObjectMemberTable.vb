#Region "Microsoft.VisualBasic::587d184637174677a15bf21a32d8bcdf, vs_solutions\VBS\src\VBScript\Syntax\Vectorization\ObjectMemberTable.vb"
    ...
    '   Total Lines: 285
    '    Code Lines: 160 (56.14%)
    ' Comment Lines: 64 (22.46%)
    '    - Xml Docs: 78.12%
    ' 
    '   Blank Lines: 61 (21.40%)
    '     File Size: 12.53 KB


    '     Class ObjectMemberTable
    ' 
    '         Properties: TypeNames
    ' 
    '         Constructor: (+1 Overloads) Sub New
    ' 
    '         Function: FromTypeBlocks, ParseTypeText, ResolveAsClause, ResolveElementType, ResolveType
    '                   TryGetMember
    ' 
    '         Sub: AddMember, AddMembers, AddTypeBlock, MarkConflict
    ' 
    ' 
    ' /********************************************************************************/

#Region "Microsoft.VisualBasic::55bccc61d2a139841ec8cded7392a03f, vs_solutions\VBS\src\VBScript\Syntax\Vectorization\SimdVocabulary.vb"
    ...
    '   Total Lines: 420
    '    Code Lines: 243 (57.86%)
    ' Comment Lines: 104 (24.76%)
    '    - Xml Docs: 89.42%
    ' 
    ...
    ' 
    '     Module SimdVocabulary
    ' 
    '         Function: Coerce, ConvertCall, EmitBinary, EmitMathFunction, EmitNegate
    '                   EmitReduce, InvokeTarget, IsMathFunctionName, IsReduceName, MapCall
    '                   MathResult, MethodName, ReduceResult, ResultKind
    ' 
    ' 
    ' /********************************************************************************/

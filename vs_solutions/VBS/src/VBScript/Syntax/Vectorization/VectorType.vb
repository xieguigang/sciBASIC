#Region "Microsoft.VisualBasic::5b5219ec45aadde809c0e5f24422a5e7, vs_solutions\VBS\src\VBScript\Syntax\Vectorization\VectorType.vb"
    ...
    '   Total Lines: 370
    '    Code Lines: 183 (49.46%)
    ' Comment Lines: 131 (35.41%)
    '    - Xml Docs: 90.08%
    ' 
    '   Blank Lines: 56 (15.14%)
    '     File Size: 16.09 KB
    ...
    ' 
    ' 
    '     Structure ValueTypeInfo
    ' 
    '         Properties: IsKnown, IsNumericScalar, IsNumericVector, IsObjectVector
    ' 
    ...
    '     Module VectorType
    ' 
    '         Function: DisplayName, DivideKind, IntegerDivideKind, LiteralKind, ModuloKind
    '                   PowerKind, Promote, SimpleTypeName, TryParseKind
    ' 
    ' 
    ' /********************************************************************************/

#Region "Microsoft.VisualBasic::39f2c13a49e623c2796651a9978984c7, vs_solutions\dev\VisualStudio\IL\MethodAnalyzer.vb"
...
'   Total Lines: 220
'    Code Lines: 170 (77.27%)
' Comment Lines: 14 (6.36%)
'    - Xml Docs: 0.00%
' 
...
' 
'     Function: AnalyzeMethod, GetNormalizedTypeName, GetOpCode, GetOperandSize
' 
'     Sub: AddCustomType, HandleConversionOpCodes, ProcessMethod
' 
' /********************************************************************************/
...
Namespace IL
    ...
    Public Class MethodAnalyzer
        ...
        Private Sub AddCustomType(type As Type, ByRef types As HashSet(Of String), currentAssembly As String)
            ...
            If Not type.Assembly.GlobalAssemblyCache AndAlso type.Assembly.GetName().Name = currentAssembly Then
                types.Add(typeName)
            End If
        End Sub

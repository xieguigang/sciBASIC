#Region "Microsoft.VisualBasic::f524bf6f1a64f85530cefa633b142550, vs_solutions\dev\VisualStudio\IL\Syntax\Expressions.vb"
    ...
    '   Total Lines: 318
    '    Code Lines: 214 (67.30%)
    ' Comment Lines: 38 (11.95%)
    '    - Xml Docs: 89.47%
    ' 
    '   Blank Lines: 66 (20.75%)
    '     File Size: 11.63 KB
    ...
    ' 
    '         Properties: Index, Name, SsaName, Version
    ' 
    '         Constructor: (+2 Overloads) Sub New
    '         Function: ToString
    ' 
    ...
    ' 
    '         Properties: IsChecked, Operand, TargetType
    ' 
    '         Constructor: (+2 Overloads) Sub New
    '         Function: ToString
    ' 
    ...
    ' 
    '         Properties: AllArguments, Arguments, DeclaringTypeName, FullName, Instance
    '                     IsStaticCall, Method, MethodName
    ' 
    ...
    ' 
    '         Properties: Condition, WhenFalse, WhenTrue
    ' 
    '         Constructor: (+2 Overloads) Sub New
    '         Function: ToString
    ' 
    ...
    '     Class PhiExpression
    ' 
    '         Properties: Arguments, TargetName
    ' 
    '         Constructor: (+1 Overloads) Sub New
    '         Function: ToString
    ' 

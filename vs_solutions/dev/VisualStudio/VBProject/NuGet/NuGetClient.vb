#Region "Microsoft.VisualBasic::0b0cd6cd22d80259d4f97e701c820708, vs_solutions\dev\VisualStudio\VBProject\NuGet\NuGetClient.vb"
    ...
    '   Total Lines: 315
    '    Code Lines: 206 (65.40%)
    ' Comment Lines: 49 (15.56%)
    '    - Xml Docs: 87.76%
    ' 
    '   Blank Lines: 60 (19.05%)
    '     File Size: 13.49 KB


    '     Class NuGetClient
    ' 
    '         Properties: CacheRoot, DefaultCacheRoot, Source
    ' 
    '         Constructor: (+2 Overloads) Sub New
    ' 
    '         Function: ContentHash, FindNuspec, GetBestVersion, GetPackageFolder, GetVersions
    '                   Install, IsInstalled, ParseVersionIndex
    ' 
    '         Sub: Cleanup, ClearVersionCache, Download, DownloadAndExtract
    ' 
    ' 
    ' /********************************************************************************/

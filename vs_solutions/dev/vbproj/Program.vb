...
Module Program
    ...
    <ExportAPI("/sources")>
    <Usage("/sources /in <*.vbproj>")>
    Public Function EnumerateAllSourceFiles(args As CLI) As Integer
        Dim [in] As String = args <= "/in"
        Dim vbproj As Project = Project.Load(file:=[in])
        Dim files = vbproj.EnumerateSourceFiles.ToArray

        For Each file As String In files
            Call Console.WriteLine(file)
        Next
